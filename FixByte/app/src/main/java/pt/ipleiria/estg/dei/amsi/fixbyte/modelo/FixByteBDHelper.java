...
public class FixByteBDHelper extends SQLiteOpenHelper {
    ...
    private static final String TABLE_NAME_REPARACAO = "reparacao";
    ...
    public void createTableReparacao(SQLiteDatabase db) {
        String createReparacaotable = "CREATE TABLE " + TABLE_NAME_REPARACAO + "(idreparacao INTEGER PRIMARY KEY AUTOINCREMENT, " +
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        this.onCreate(db);
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_NAME_REPARACAO);
        this.onCreate(db);
    }
    ...
    public Reparacao adicionarReparacaoBD(Reparacao reparacao){
        ...
        long id = this.database.insert(TABLE_NAME_REPARACAO, null,values);
    ...
    public boolean editarReparacaoBD(Reparacao reparacao){
        ...
        return this.database.update(TABLE_NAME_REPARACAO, values, "idreparacao = ?", new String[]{"" + reparacao.getIdreparacao()})>0;
    }
    public boolean removerReparacaoBD (long idreparacao){
        return this.database.delete(TABLE_NAME_REPARACAO, "idreparacao = ?", new String[]{"" + idreparacao})==1;
    ...
    public ArrayList<Reparacao> getAllReparacoesBD(){
        ...
        Cursor cursor = this.database.query(TABLE_NAME_REPARACAO,new String[]{"idreparacao", REPARACAONOME,REPARACAOESTADO,REPARACAONUMERO,REPARACAODATA,REPARACAODATACONCLUIDO,REPARACAODESCRICAO,USER_IDUSER},null,null,null,null,null);
    ...
    public void removeAllReparacoes(){
        this.database.delete(TABLE_NAME_REPARACAO,null,null);
    }
    //endregion
}
